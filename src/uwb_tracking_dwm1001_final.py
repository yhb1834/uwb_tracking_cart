...
def calculate_point_coordinates2(distance1, distance2, distance3):
    ...
    if (distance1 == 0):
        x = point1[0]
        y = point1[1]
    elif (distance1 + distance2 < dist_anchor):
        x = last_x
        y = last_y
    else:
            ...
            while not rospy.is_shutdown():
                ...
                try:
                    ...
                    if anchor1_result < 0:
                        ...
                        anchor1_result = last_result * 0.9 + anchor1_result * 0.1#sum(anchor1_results)/len(anchor1_results) * 0.9 + anchor1_result * 0.1
                    ...
                    if anchor2_result < 0:
                        ...
                        anchor2_result = last_result * 0.9 + anchor2_result * 0.1#sum(anchor1_results)/len(anchor1_results) * 0.9 + anchor1_result * 0.1
                    ...
                    if anchor3_result < 0:
                        ...
                        anchor3_result = last_result * 0.9 + anchor3_result * 0.1#sum(anchor1_results)/len(anchor1_results) * 0.9 + anchor1_result * 0.1
